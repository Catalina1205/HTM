...
const validarPassword2 = () => {
  ...
  const habilitarBoton = () => {
	if (campos.nombre && campos.apellido && campos.numero && campos.numeroCelular && campos.numeroTelefono && campos.edad && campos.password && campos.password2 && terminos.checked) {
